...
export default function InitialA() {
  ...
  useEffect(() => {
    if (promotions.length === 0) return; // Verificar si promotions tiene algún valor antes de proceder
  ...
  if (promotions.length === 0) {
    return <div>Loading...</div>; // Mostrar un mensaje de carga si promotions está vacío
  }
