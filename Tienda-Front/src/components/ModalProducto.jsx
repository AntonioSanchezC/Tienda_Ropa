...
export default function ModalProducto() {
    const { product, handleClickModal, handleAgregarPedido, order } = useQuisco();
    console.log("El valor de product desde ModalProducto es ", product);
    ...
    // Obtener la ruta de la imagen desde el array imgs
