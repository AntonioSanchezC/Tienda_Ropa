...
Route::middleware('auth:sanctum')->group(function() {
    ...
    Route::get('/productsAdminSex/{gender}', [ProductController::class, 'indexAdminSex']);
...
Route::get('/products/{product_code}/by-code', [ProductController::class, 'getProductsByCode']);
